...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        //conectar o app e configurar com a database do firebase
        //o primeiro arquivo que é chamado é o delegate
        
        FirebaseApp.configure()
        
        //o código serviu pra testar se conseguia obter os dados, como foi possível, não é mais necessário manter. Foi retirado também para gravar as mensagens anteriores que foram mandadas.
